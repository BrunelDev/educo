...
export class ConsultationsService {
  ...
  async getConsultations(page?: number): Promise<PaginatedConsultation> {
    try {
      ...
      logger.error("Erreur lors de la récupération des consultations", {
        error,
        page,
      });
      throw error;
  ...
  async getConsultation(id: number): Promise<Consultation> {
    try {
      ...
      logger.error("Erreur lors de la récupération de la consultation", {
        error,
        id,
      });
      throw error;
  ...
  async updateConsultation(
    ...
    try {
      ...
      logger.error("Erreur lors de la mise à jour de la consultation", {
        error,
        id,
      });
      throw error;
  ...
  async deleteConsultation(id: number): Promise<void> {
    try {
      ...
      logger.error("Erreur lors de la suppression de la consultation", {
        error,
        id,
      });
      throw error;
  ...
  async getCommentaires(
    ...
    try {
      ...
      logger.error("Erreur lors de la récupération des commentaires", {
        error,
        consultationId,
      });
      throw error;
  ...
  async addCommentaire(
    ...
    try {
      ...
      logger.error("Erreur lors de l'ajout du commentaire", {
        error,
        consultationId,
      });
      throw error;
