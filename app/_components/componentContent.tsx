...
import CommentInput from '../(workspace)/gestion/details/details_de_la_tache/components/commentInput'
import ParticipantComponent from '../(workspace)/gestion/details/details_de_la_tache/components/participants'
