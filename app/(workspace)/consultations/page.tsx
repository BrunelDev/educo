...
const consultationTitles = [
  { title: "Orientations pédagogiques et stratégiques", barNumber: 1 },
  { title: "Budget et ressources académiques", barNumber: 1 },
  { title: "Politique de formation et conditions d'enseignement", barNumber: 2 },
  { title: "Introduction de nouvelles technologies pédagogiques", barNumber: 2 },
  { title: "Modification des programmes d'enseignement", barNumber: 1 },
  { title: "Partenariats et coopérations universitaires", barNumber: 2 },
  { title: "Développement des compétences du personnel", barNumber: 1 },
  { title: "Règlement intérieur académique", barNumber: 1 },
  { title: "Conventions et accords pédagogiques", barNumber: 1 },
  { title: "Organisation des examens et évaluations", barNumber: 1 },
  { title: "Aménagement des espaces d'enseignement", barNumber: 1 },
  { title: "Qualité de vie et conditions d'études", barNumber: 1 },
];
  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-wrap gap-2 mb-8">
        {consultationTitles.map((consultationTitle, index) => (
          <DialogComponent
