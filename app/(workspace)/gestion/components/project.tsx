...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div className= "bg-[#ffffff] hover:bg-white-100 w-[300px] h-[120px] rounded-[12px] py-4 px-3 flex flex-col justify-between text-sm cursor-pointer" onClick={()=> router.push(`/gestion/details/${project.id}`)}>
